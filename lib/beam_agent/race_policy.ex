defmodule BeamAgent.RacePolicy do
  ...
  defp role(nil), do: "Race candidate"
  defp role(approach), do: "Race candidate (#{approach})"
  ...
  defp justification(count) do
    "Runtime race of #{count} independent attempts at one outcome; select a winner, never merge"
  end
