defmodule BeamAgent.CLI.UI do
  ...
  def command_help do
    ...
    command("/budget", "show goal and worker resource allocations")
    command("/repository", "show reactive repository and Git state")
    command("/resources", "show scheduler pools and queue depth")
    command("/organizations", "show temporary worker organizations")
    command("/worktrees", "show isolated Git worktrees")
